...
def plot_csv(train_values, val_values, train_std, val_std):
...
root_directory = "C:\\Users\\faulhamm\\Documents\\Philipp\\Code\\cc-machine-learning\\results\\dataset_v2_42_images"
...
plot_csv(train_mean_iou, val_mean_iou, train_std_iou, val_std_iou)